...
function GoodsItemBuilder(item: ProductItem, index: number, mode: string, parent = null) {
                        ...
                        const forEachItemGenFunction = (_item, index: number) => {
                            const item = _item;
                            {
                                ...
                                const observedDeepRender = () => {
                                    ...
                                    GoodsItemBuilder.bind(this)(item, index, this.currentMode);
                                    GridItem.pop();
                                };
                                observedDeepRender();
                            }
...
registerNamedRoute(() => new HomePage(undefined, {}), "", { bundleName: "com.atomicservice.6917609041042536136", moduleName: "entry", pagePath: "pages/HomePage", pageFullPath: "entry/src/main/ets/pages/HomePage", integratedHsp: "false", moduleType: "followWithHap" });
