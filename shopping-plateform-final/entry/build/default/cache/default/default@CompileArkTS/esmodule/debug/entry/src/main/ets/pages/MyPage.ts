...
export class MyPage extends ViewPU {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.isLoggedIn) {
                this.ifElseBranchUpdateFunction(0, () => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 用户头像
                        Image.create((this.currentUser?.avatar || this.userAvatar) || { "id": 16777243, "type": 20000, params: [], "bundleName": "com.atomicservice.6917609041042536136", "moduleName": "entry" });
                        // 用户头像
                        Image.width(80);
                        // 用户头像
                        Image.height(80);
                    ...
                    Column.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 125830088, "type": 20000, params: [], "bundleName": "com.atomicservice.6917609041042536136", "moduleName": "entry" });
                        Image.width(24);
                        Image.height(24);
                        Image.fillColor({ "id": 125829216, "type": 10001, params: [], "bundleName": "com.atomicservice.6917609041042536136", "moduleName": "entry" });
                    }, Image);
                    // 已登录状态
                    Row.pop();
                });
    ...
    QuickEntrySection(parent = null) {
        ...
        this.QuickEntryItem.bind(this)('商品浏览', { "id": 16777261, "type": 20000, params: [], "bundleName": "com.atomicservice.6917609041042536136", "moduleName": "entry" }, () => {
            router.pushUrl({ url: 'pages/Index' });
        });
        this.QuickEntryItem.bind(this)('我的订单', { "id": 16777250, "type": 20000, params: [], "bundleName": "com.atomicservice.6917609041042536136", "moduleName": "entry" }, () => { this.goToOrderList(); });
        this.QuickEntryItem.bind(this)('收藏夹', { "id": 16777263, "type": 20000, params: [], "bundleName": "com.atomicservice.6917609041042536136", "moduleName": "entry" }, () => {
            if (!this.isLoggedIn) {
                this.goToLogin();
                return;
            }
