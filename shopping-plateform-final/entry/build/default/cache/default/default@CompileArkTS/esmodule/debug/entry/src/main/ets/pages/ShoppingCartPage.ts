...
export class ShoppingCartPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1, paramsLambda = undefined, extraInfo) {
        ...
        this.declareWatch("currentMode", this.onModeChange);
