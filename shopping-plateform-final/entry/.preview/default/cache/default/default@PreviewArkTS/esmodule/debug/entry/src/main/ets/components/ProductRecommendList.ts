...
export class ProductRecommendList extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(103:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 标题
            Row.create();
            Row.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(105:7)", "entry");
            // 标题
            Row.width('100%');
            // 标题
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create({ "id": 16777268, "type": 10003, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" });
            Text.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(106:9)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 商品列表
            List.create();
            List.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(115:7)", "entry");
            // 商品列表
            List.width('100%');
            // 商品列表
            List.layoutWeight(1);
            ...
            const forEachItemGenFunction = _item => {
                const product = _item;
                {
                    ...
                    const itemCreation2 = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(117:11)", "entry");
                    };
    ...
    ProductCard(product: Product, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(135:5)", "entry");
            Row.width('100%');
            Row.padding(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 商品图片
            Column.create();
            Column.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(137:7)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            if (product.image) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(139:11)", "entry");
                        Image.width(100);
                        Image.height(100);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(145:11)", "entry");
                        Column.width(100);
                        Column.height(100);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(146:13)", "entry");
                        Image.width(48);
                        Image.height(48);
                        Image.opacity(0.5);
                    }, Image);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 商品信息
            Column.create();
            Column.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(160:7)", "entry");
            // 商品信息
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(161:9)", "entry");
            Text.fontSize(16);
            Text.fontColor({ "id": 125829210, "type": 10001, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" });
            Text.fontWeight(FontWeight.Medium);
            Text.maxLines(2);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(169:9)", "entry");
            Text.fontSize(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(176:9)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`¥${product.price}`);
            Text.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(177:11)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(182:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(product.seller);
            Text.debugLine("entry/src/main/ets/components/ProductRecommendList.ets(184:11)", "entry");
            Text.fontSize(12);
            Text.fontColor({ "id": 125829216, "type": 10001, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" });
        }, Text);
        Text.pop();
