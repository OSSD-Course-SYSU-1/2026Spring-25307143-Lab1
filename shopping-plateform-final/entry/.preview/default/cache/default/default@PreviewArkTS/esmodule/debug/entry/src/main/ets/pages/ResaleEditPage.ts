...
class ResaleEditPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(109:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 标题栏
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(111:7)", "entry");
            // 标题栏
            Row.width('100%');
            // 标题栏
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(112:9)", "entry");
            Image.width(24);
            Image.height(24);
            Image.onClick(() => {
                router.back();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('编辑转售信息');
            Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(119:9)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(125:9)", "entry");
            Blank.width(24);
        }, Blank);
        Blank.pop();
        // 标题栏
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(133:7)", "entry");
            Scroll.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(134:9)", "entry");
            Column.width('100%');
            Column.padding(16);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 商品信息卡片
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(136:11)", "entry");
            // 商品信息卡片
            Column.width('100%');
            // 商品信息卡片
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('商品信息');
            Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(137:13)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Medium);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.productData) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(144:15)", "entry");
                        Row.width('100%');
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create(this.productData.imageUrl);
                        Image.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(145:17)", "entry");
                        Image.width(100);
                        Image.height(100);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(151:17)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(152:19)", "entry");
                        Text.fontSize(16);
                        Text.fontWeight(FontWeight.Medium);
                        Text.maxLines(2);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(158:19)", "entry");
                        Text.fontSize(12);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(163:19)", "entry");
                        Row.margin({ top: 8 });
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create(`原价: ¥${this.productData.price}`);
                        Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(164:21)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#999999');
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(168:21)", "entry");
                        Text.fontSize(12);
                        Text.fontColor('#999999');
                        Text.margin({ left: 8 });
                    }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 转售价格设置
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(189:11)", "entry");
            // 转售价格设置
            Column.width('100%');
            // 转售价格设置
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('转售价格');
            Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(190:13)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Medium);
            Text.width('100%');
            Text.margin({ bottom: 12 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(196:13)", "entry");
            Row.width('100%');
            Row.alignItems(VerticalAlign.Center);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('¥');
            Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(197:15)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(202:15)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.productData) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(218:15)", "entry");
                        Row.width('100%');
                        Row.margin({ top: 8 });
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        if (this.resalePrice > this.productData.price) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(220:19)", "entry");
                                    Text.fontSize(12);
                                    Text.fontColor('#FF5722');
                                }, Text);
                                Text.pop();
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(224:19)", "entry");
                                    Text.fontSize(12);
                            ...
                            this.ifElseBranchUpdateFunction(2, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('与原价相同');
                                    Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(228:19)", "entry");
                                    Text.fontSize(12);
                                    Text.fontColor('#999999');
                                }, Text);
                                Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 转售描述
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(244:11)", "entry");
            // 转售描述
            Column.width('100%');
            // 转售描述
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('转售描述（可选）');
            Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(245:13)", "entry");
            Text.fontSize(16);
            Text.fontWeight(FontWeight.Medium);
            Text.width('100%');
            Text.margin({ bottom: 12 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextArea.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(251:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 温馨提示
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(268:11)", "entry");
            // 温馨提示
            Column.width('100%');
            // 温馨提示
            Column.padding(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('温馨提示');
            Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(269:13)", "entry");
            Text.fontSize(14);
            Text.fontWeight(FontWeight.Medium);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(275:13)", "entry");
            Text.fontSize(12);
            Text.fontColor('#999999');
            Text.lineHeight(20);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 底部发布按钮
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(296:7)", "entry");
            // 底部发布按钮
            Column.width('100%');
            // 底部发布按钮
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/ResaleEditPage.ets(297:9)", "entry");
            Button.width('100%');
            Button.height(50);
            Button.fontSize(18);
...
registerNamedRoute(() => new ResaleEditPage(undefined, {}), "", { bundleName: "com.atomicservice.account_atomicservice_sample", moduleName: "entry", pagePath: "pages/ResaleEditPage", pageFullPath: "entry/src/main/ets/pages/ResaleEditPage", integratedHsp: "false", moduleType: "followWithHap" });
