...
import { HomePage } from "@bundle:com.atomicservice.account_atomicservice_sample/entry/ets/pages/HomePage";
import { MessagePage } from "@bundle:com.atomicservice.account_atomicservice_sample/entry/ets/pages/MessagePage";
import { ModeSwitchPage } from "@bundle:com.atomicservice.account_atomicservice_sample/entry/ets/pages/ModeSwitchPage";
import { ShoppingCartPage } from "@bundle:com.atomicservice.account_atomicservice_sample/entry/ets/pages/ShoppingCartPage";
import { MyPage } from "@bundle:com.atomicservice.account_atomicservice_sample/entry/ets/pages/MyPage";
import { ErrorCode } from "@bundle:com.atomicservice.account_atomicservice_sample/entry/ets/common/ErrorCodeEntity";
...
class Index extends ViewPU {
    ...
    private getPageTitle(): Resource {
        if (this.currentPage === 'HomePage') {
            return { "id": 16777242, "type": 10003, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
        else if (this.currentPage === 'MessagePage') {
            return { "id": 16777252, "type": 10003, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
        else if (this.currentPage === 'ModeSwitchPage') {
            // 根据当前模式显示不同的标题
            return this.currentMode === 'shopping' ? { "id": 16777249, "type": 10003, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" } : { "id": 16777278, "type": 10003, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
        else if (this.currentPage === 'ShoppingCartPage') {
            return { "id": 16777277, "type": 10003, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
        else {
            return { "id": 16777257, "type": 10003, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
    }
    // 获取导航栏图标
    private getNavIcon(pageName: PageType): Resource {
        if (pageName === 'HomePage') {
            return this.currentPage === pageName ? { "id": 16777223, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" } : { "id": 16777303, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
        else if (pageName === 'MessagePage') {
            return this.currentPage === pageName ? { "id": 16777300, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" } : { "id": 16777286, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
        else if (pageName === 'ModeSwitchPage') {
            return this.currentPage === pageName ? { "id": 16777220, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" } : { "id": 16777294, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
        else if (pageName === 'ShoppingCartPage') {
            return this.currentPage === pageName ? { "id": 16777302, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" } : { "id": 16777295, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
        else {
            return this.currentPage === pageName ? { "id": 16777301, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" } : { "id": 16777221, "type": 20000, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" };
        }
    }
    // 获取导航栏文字
    ...
    NavBar(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/ets/pages/Index.ets(297:5)", "entry");
            Flex.shadow({
            ...
            Flex.backgroundColor({ "id": 125829552, "type": 10001, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" });
        }, Flex);
    ...
    Unit(routerName: PageType, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(322:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/Index.ets(323:7)", "entry");
            Image.width(24);
            Image.height(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/Index.ets(328:7)", "entry");
            Text.fontSize(10);
            Text.lineHeight(13);
            Text.fontColor(this.currentPage === routerName ? { "id": 16777287, "type": 10001, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" } : { "id": 125829216, "type": 10001, params: [], "bundleName": "com.atomicservice.account_atomicservice_sample", "moduleName": "entry" });
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Flex.debugLine("entry/src/main/ets/pages/Index.ets(352:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/Index.ets(356:7)", "entry");
            Column.layoutWeight(1);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Index.ets(357:9)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/Index.ets(358:11)", "entry");
            Text.fontSize(28);
            Text.lineHeight(36);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Index.ets(369:9)", "entry");
            Row.layoutWeight(1);
                ...
                this.ifElseBranchUpdateFunction(0, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new HomePage(this, { mainBoxPadding: this.mainBoxPadding, currentMode: this.currentMode }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 371, col: 13 });
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new MessagePage(this, { mainBoxPadding: this.mainBoxPadding }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 373, col: 13 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        mainBoxPadding: this.mainBoxPadding
                ...
                this.ifElseBranchUpdateFunction(2, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new ModeSwitchPage(this, { mainBoxPadding: this.mainBoxPadding, currentMode: this.currentMode }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 375, col: 13 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        mainBoxPadding: this.mainBoxPadding,
                ...
                this.ifElseBranchUpdateFunction(3, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new ShoppingCartPage(this, { mainBoxPadding: this.mainBoxPadding, currentMode: this.currentMode }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 377, col: 13 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        mainBoxPadding: this.mainBoxPadding,
                ...
                this.ifElseBranchUpdateFunction(4, () => {
                    {
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            if (isInitialRender) {
                                let componentCall = new MyPage(this, { mainBoxPadding: this.mainBoxPadding }, undefined, elmtId, () => { }, { page: "entry/src/main/ets/pages/Index.ets", line: 379, col: 13 });
                                ViewPU.create(componentCall);
                                let paramsLambda = () => {
                                    return {
                                        mainBoxPadding: this.mainBoxPadding
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/Index.ets(386:7)", "entry");
        }, Row);
...
if (storage && storage.routeName != undefined && storage.storage != undefined) {
    registerNamedRoute(() => new Index(undefined, {}, storage.useSharedStorage ? LocalStorage.getShared() : storage.storage), storage.routeName, { bundleName: "com.atomicservice.account_atomicservice_sample", moduleName: "entry", pagePath: "pages/Index", pageFullPath: "entry/src/main/ets/pages/Index", integratedHsp: "false", moduleType: "followWithHap" });
}
else if (storage && storage.routeName != undefined && storage.storage == undefined) {
    registerNamedRoute(() => new Index(undefined, {}, storage.useSharedStorage ? LocalStorage.getShared() : storage.storage), storage.routeName, { bundleName: "com.atomicservice.account_atomicservice_sample", moduleName: "entry", pagePath: "pages/Index", pageFullPath: "entry/src/main/ets/pages/Index", integratedHsp: "false", moduleType: "followWithHap" });
}
else if (storage && storage.routeName == undefined && storage.storage != undefined) {
    registerNamedRoute(() => new Index(undefined, {}, storage.useSharedStorage ? LocalStorage.getShared() : storage.storage), "", { bundleName: "com.atomicservice.account_atomicservice_sample", moduleName: "entry", pagePath: "pages/Index", pageFullPath: "entry/src/main/ets/pages/Index", integratedHsp: "false", moduleType: "followWithHap" });
}
else if (storage && storage.useSharedStorage != undefined) {
    registerNamedRoute(() => new Index(undefined, {}, storage.useSharedStorage ? LocalStorage.getShared() : undefined), "", { bundleName: "com.atomicservice.account_atomicservice_sample", moduleName: "entry", pagePath: "pages/Index", pageFullPath: "entry/src/main/ets/pages/Index", integratedHsp: "false", moduleType: "followWithHap" });
}
else {
    registerNamedRoute(() => new Index(undefined, {}, storage), "", { bundleName: "com.atomicservice.account_atomicservice_sample", moduleName: "entry", pagePath: "pages/Index", pageFullPath: "entry/src/main/ets/pages/Index", integratedHsp: "false", moduleType: "followWithHap" });
}
