...
import type { OrderRecord } from "@bundle:com.atomicservice.account_atomicservice_sample/entry/ets/common/OrderManager";
...
class PaymentPage extends ViewPU {
    ...
    goToOrderDetail() {
        ...
        const orderPayTime = new Date(now.getTime() + 2000).toLocaleString();
        const orderId = OrderManager.getInstance().generateOrderId();
        // 创建订单记录并保存到OrderManager
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(142:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 顶部导航栏
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/PaymentPage.ets(144:7)", "entry");
            // 顶部导航栏
            Row.width('100%');
            // 顶部导航栏
            Row.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/PaymentPage.ets(145:9)", "entry");
            Button.width(40);
            Button.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/PaymentPage.ets(146:11)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('←');
            Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(147:13)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/PaymentPage.ets(159:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.getPaymentMethodName());
            Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(161:9)", "entry");
            Text.fontSize(18);
            Text.fontColor(Color.White);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/PaymentPage.ets(166:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/PaymentPage.ets(168:9)", "entry");
            Row.width(40);
            Row.height(40);
        }, Row);
        Row.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.isLoading) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(178:9)", "entry");
                        Column.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        LoadingProgress.debugLine("entry/src/main/ets/pages/PaymentPage.ets(179:11)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('加载中...');
                        Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(184:11)", "entry");
                        Text.fontSize(14);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(193:9)", "entry");
                        Column.width('100%');
                        Column.layoutWeight(1);
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 支付金额
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(195:11)", "entry");
                        // 支付金额
                        Column.width('100%');
                        // 支付金额
                        Column.padding(30);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('支付金额');
                        Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(196:13)", "entry");
                        Text.fontSize(16);
                        ...
                        if (this.productData) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(202:15)", "entry");
                                    Text.fontSize(36);
                        ...
                        if (this.paymentStatus === 'pending' && !this.isPaying) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    // 待支付状态
                                    Column.create();
                                    Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(215:13)", "entry");
                                    // 待支付状态
                                    Column.width('100%');
                                    // 待支付状态
                                    Column.padding(20);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('请确认支付');
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(216:15)", "entry");
                                    Text.fontSize(16);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Button.debugLine("entry/src/main/ets/pages/PaymentPage.ets(221:15)", "entry");
                                    Button.fontSize(16);
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    // 支付中状态
                                    Column.create();
                                    Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(236:13)", "entry");
                                    // 支付中状态
                                    Column.width('100%');
                                    // 支付中状态
                                    Column.padding(20);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    LoadingProgress.create();
                                    LoadingProgress.debugLine("entry/src/main/ets/pages/PaymentPage.ets(237:15)", "entry");
                                    LoadingProgress.width(50);
                                    LoadingProgress.height(50);
                                    LoadingProgress.color('#FF5722');
                                }, LoadingProgress);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('支付中，请稍候...');
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(242:15)", "entry");
                                    Text.fontSize(16);
                                    Text.fontColor('#666666');
                                    Text.margin({ top: 20 });
                                }, Text);
                            ...
                            this.ifElseBranchUpdateFunction(2, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    // 支付成功状态
                                    Column.create();
                                    Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(251:13)", "entry");
                                    // 支付成功状态
                                    Column.width('100%');
                                    // 支付成功状态
                                    Column.padding(20);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('✓');
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(252:15)", "entry");
                                    Text.fontSize(60);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('支付成功');
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(257:15)", "entry");
                                    Text.fontSize(20);
                                    Text.fontColor('#4CAF50');
                                    Text.fontWeight(FontWeight.Bold);
                                }, Text);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(262:15)", "entry");
                                    Text.fontSize(14);
                                    Text.fontColor('#999999');
                                    Text.margin({ top: 12 });
                                }, Text);
                            ...
                            this.ifElseBranchUpdateFunction(3, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    // 支付失败状态
                                    Column.create();
                                    Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(271:13)", "entry");
                                    // 支付失败状态
                                    Column.width('100%');
                                    // 支付失败状态
                                    Column.padding(20);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('✗');
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(272:15)", "entry");
                                    Text.fontSize(60);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('支付失败');
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(277:15)", "entry");
                                    Text.fontSize(20);
                                    Text.fontColor('#F44336');
                                    Text.fontWeight(FontWeight.Bold);
                                }, Text);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Button.debugLine("entry/src/main/ets/pages/PaymentPage.ets(282:15)", "entry");
                                    Button.fontSize(16);
                                    Button.fontColor(Color.White);
                                    Button.backgroundColor('#FF5722');
                                    Button.borderRadius(20);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        if (this.productData) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(300:13)", "entry");
                                    Column.width('100%');
                                    Column.padding(16);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create();
                                    Row.debugLine("entry/src/main/ets/pages/PaymentPage.ets(301:15)", "entry");
                                    Row.width('100%');
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Image.create(this.productData.imageUrl);
                                    Image.debugLine("entry/src/main/ets/pages/PaymentPage.ets(302:17)", "entry");
                                    Image.width(60);
                                    Image.height(60);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create();
                                    Column.debugLine("entry/src/main/ets/pages/PaymentPage.ets(308:17)", "entry");
                                    Column.layoutWeight(1);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(309:19)", "entry");
                                    Text.fontSize(14);
                                    Text.fontColor('#333333');
                                    Text.maxLines(2);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/PaymentPage.ets(316:19)", "entry");
                                    Text.fontSize(14);
                                    Text.fontColor('#FF5722');
                                    Text.margin({ top: 4 });
                                }, Text);
...
registerNamedRoute(() => new PaymentPage(undefined, {}), "", { bundleName: "com.atomicservice.account_atomicservice_sample", moduleName: "entry", pagePath: "pages/PaymentPage", pageFullPath: "entry/src/main/ets/pages/PaymentPage", integratedHsp: "false", moduleType: "followWithHap" });
